...
<div class="inline-flex align-items-center">
    ...
    @if (auth()->user()->hasRole('customer') && $row->status === 'delivering')
      ...
      <span data-order-id={{ $id }} data-order-status='returned' class="show-return-modal inline-flex me-4 border bg-cyan-400 hover:bg-cyan-500 text-white px-4 py-2 text-xs rounded-md show-reject-modal">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 me-2 font-bold">
