@php
    $statusArr = (object) [
      ...
      [
        'name' => 'packing',
        'activeStyle' => '!bg-orange-100 !text-orange-800',
        'hoverStyle' => 'hover:bg-orange-100 hover:text-orange-800',
        'icon' => '<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" 
                    stroke="currentColor" class="w-4 h-4 me-2 font-bold">
...
<div class="flex mb-4">
  ...
  <div
      ...
      {{ $this->status == $item['name'] ? $item['activeStyle'] : '' }}">
      {!! $item['icon'] !!}
